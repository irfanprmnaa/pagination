...
<html lang="en">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="<?php echo base_url() ?>assets2/assets/images/users/avatar.jpg" alt="John Doe"/>
                        </a>
                        <div class="profile">
                            ...
                            <div class="profile-controls">
                                <a href="<?php echo base_url() ?>assets2/pages-profile.html" class="profile-control-left"><span class="fa fa-info"></span></a>
                                <a href="<?php echo base_url() ?>assets2/pages-messages.html" class="profile-control-right"><span class="fa fa-envelope"></span></a>
                            </div>
                        </div>                                                                        
                    </li>
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo base_url() ?>assets2/pages-profile.html"><span class="fa fa-user"></span> Profile</a></li>
                            <li><a href="<?php echo base_url() ?>assets2/pages-address-book.html"><span class="fa fa-users"></span> Address Book</a></li>
                            <li class="xn-openable">
                                <a href="#"><span class="fa fa-clock-o"></span> Timeline</a>
                                <ul>
                                    <li><a href="<?php echo base_url() ?>assets2/pages-timeline.html"><span class="fa fa-align-center"></span> Default</a></li>
                                    <li><a href="<?php echo base_url() ?>assets2/pages-timeline-simple.html"><span class="fa fa-align-justify"></span> Full Width</a></li>
                                </ul>
                            </li>
                            <li class="xn-openable">
                ...
                <div class="content-frame">   
                    ...
                    <div class="content-frame-body content-frame-body-left">
                        ...
                        <div class="gallery" id="links">
                            ...
                            <a class="gallery-item" href="<?php echo base_url() ?>assets2/assets/images/gallery/nature-1.jpg" title="Nature Image 1" data-gallery>
                                <div class="image">                              
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/nature-1.jpg" alt="Nature Image 1"/>                                        
                            ...
                            <a class="gallery-item" href="<?php echo base_url() ?>assets2/assets/images/gallery/music-1.jpg" title="Music picture 1" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/music-1.jpg" alt="Music picture 1"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/girls-1.jpg" title="Girls Image 1" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/girls-1.jpg" alt="Girls Image 1"/>                                        
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/nature-2.jpg" title="Nature Image 2" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/nature-2.jpg" alt="Nature Image 2"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/space-1.jpg" title="Space picture 1" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/space-1.jpg" alt="Space picture 1"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/music-2.jpg" title="Music picture 2" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/music-2.jpg" alt="Music picture 2"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/nature-3.jpg" title="Nature Image 3" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/nature-3.jpg" alt="Nature Image 3"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/girls-2.jpg" title="Girls Image 2" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/girls-2.jpg" alt="Girls Image 2"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/space-2.jpg" title="Space picture 2" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/space-2.jpg" alt="Space picture 2"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/nature-4.jpg" title="Nature Image 4" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/nature-4.jpg" alt="Nature Image 4"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/music-3.jpg" title="Music picture 3" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/music-3.jpg" alt="Music picture 3"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/nature-5.jpg" title="Nature Image 5" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/nature-5.jpg" alt="Nature Image 5"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/nature-6.jpg" title="Nature Image 6" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/nature-6.jpg" alt="Nature Image 6"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/girls-3.jpg" title="Girls Image 3" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/girls-3.jpg" alt="Girls Image 3"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/nature-7.jpg" title="Nature Image 7" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/nature-7.jpg" alt="Nature Image 7"/>
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
                            ...
                            <a class="gallery-item" href="assets/images/gallery/music-5.jpg" title="Music picture 5" data-gallery>
                                <div class="image">
                                    <img src="<?php echo base_url() ?>assets2/assets/images/gallery/music-5.jpg" alt="Music picture 5"/>    
                                    <ul class="gallery-item-controls">
                                        <li><label class="check"><input type="checkbox" class="icheckbox"/></label></li>
                                        <li><span class="gallery-item-remove"><i class="fa fa-times"></i></span></li>
                                    </ul>                                                                    
        ...
        <div class="message-box animated fadeIn" data-sound="alert" id="mb-signout">
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="<?php echo site_url('autentikasi/logout'); ?>" class="btn btn-success btn-lg">Yes</a>
    ...
    <!-- START SCRIPTS -->
        ...
        <script type="text/javascript" src="<?php echo base_url() ?>assets2/js/plugins/jquery/jquery-ui.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url() ?>assets2/js/plugins/bootstrap/bootstrap.min.js"></script>        
        <!-- END PLUGINS -->

        <!-- START THIS PAGE PLUGINS-->        
        <script type='text/javascript' src='<?php echo base_url() ?>assets2/js/plugins/icheck/icheck.min.js'></script>
        <script type="text/javascript" src="<?php echo base_url() ?>assets2/js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js"></script>
        
        <script type="text/javascript" src="<?php echo base_url() ?>assets2/js/plugins/blueimp/jquery.blueimp-gallery.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url() ?>assets2/js/plugins/dropzone/dropzone.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url() ?>assets2/js/plugins/icheck/icheck.min.js"></script>
        <!-- END THIS PAGE PLUGINS-->        

        <!-- START TEMPLATE -->
        <script type="text/javascript" src="<?php echo base_url() ?>assets2/js/settings.js"></script>
        
        <script type="text/javascript" src="<?php echo base_url() ?>assets2/js/plugins.js"></script>        
